...
public class Oml021Builder {
    ...
    public OML_O21 build(ResolvedDisaLog resolved, String messageControlId) throws Exception {
        ...
        setMsh(oml.getMSH(), p, universalId, resolved.labCode(), messageControlId);
        setSft(oml.getSFT(0));
    ...
    private void setMsh(MSH msh, DisaLogPayload p, String universalId, String labCode, String messageControlId) throws Exception {
    ...
    /** Common order control for every ORDER group of the same clinical order. */
    private void setOrc(ORC orc, DisaLogPayload p) throws Exception {
